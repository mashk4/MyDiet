...
ActiveRecord::Schema[7.0].define(version: 20_220_910_075_018) do
  ...
  create_table 'diet_meals', force: :cascade do |t|
    ...
    t.index %w[diet_id meal_id], name: 'index_diet_meals_on_diet_id_and_meal_id', unique: true
  ...
  create_table 'diets', force: :cascade do |t|
    ...
    t.index %w[user_id date], name: 'index_diets_on_user_id_and_date', unique: true
  ...
  create_table 'eaten_product_meals', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[eaten_product_id meal_id], name: 'index_eaten_product_meals_on_eaten_product_id_and_meal_id',
                                          unique: true
  ...
  create_table 'eaten_products', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id eaten_at], name: 'index_eaten_products_on_user_id_and_eaten_at', unique: true
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.integer 'report_frequency', default: 0, null: false
    t.index ['email'], name: 'index_users_on_email', unique: true
    t.index ['report_frequency'], name: 'index_users_on_report_frequency'
